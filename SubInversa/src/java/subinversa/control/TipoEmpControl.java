...
import subinversa.servicio.TipoEmpServImpl;
import subinversa.servicio.TipoEmpServInterface;
...
public class TipoEmpControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        TipoEmpServInterface tipoEmpServ;

        switch (opc) {
            case 1: {
                System.out.println("LLego al case 1 del Tipo Empresa");
                tipoEmpServ = new TipoEmpServImpl();
                request.getSession().setAttribute("_listaTimpoEmpresa", tipoEmpServ.listaTimpoEmpresaTodo());
                response.sendRedirect("jsp/modulos/tipEmp/mainTipoEmp.jsp");
                break;
            }
            case 2: {
                tipoEmpServ = new TipoEmpServImpl();
                Tipoempresa to = new Tipoempresa();
                ...
                tipoEmpServ.insertTipoEmpresa(to);
